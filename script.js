...
`;
document.querySelector(".site-header").insertAdjacentHTML('afterbegin', headerContent);
...
document.querySelector(".site-footer").insertAdjacentHTML('afterBegin', footerContent);
